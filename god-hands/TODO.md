...
| Phase 5.4c — Building visual polish (spinning windmill, chimneys, windows, tavern mug) | ✅ Done | feature/phase-5-1 |
| Phase 5.2 — Zombie grab-and-bite | ✅ Done | claude/cool-joliot-a6dc1b |

**Next up:** Phase 5.3 (Spell level-2 long-press) or Phase 5.5 (Achievements).
